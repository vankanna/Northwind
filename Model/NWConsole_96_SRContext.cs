...
{
    public partial class NWConsole_96_SRContext : DbContext
    {
        public NWConsole_96_SRContext()
        {
        }

        public NWConsole_96_SRContext(DbContextOptions<NWConsole_96_SRContext> options)
            : base(options)
        {
        }
